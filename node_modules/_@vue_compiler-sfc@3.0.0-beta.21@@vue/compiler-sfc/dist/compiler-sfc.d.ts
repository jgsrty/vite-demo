...
export declare function parse(source: string, { sourceMap, filename, sourceRoot, pad, compiler, babelParserPlugins }?: SFCParseOptions): SFCParseResult;
...
export declare interface SFCParseOptions extends SFCScriptCompileOptions {
    filename?: string;
    sourceMap?: boolean;
    sourceRoot?: string;

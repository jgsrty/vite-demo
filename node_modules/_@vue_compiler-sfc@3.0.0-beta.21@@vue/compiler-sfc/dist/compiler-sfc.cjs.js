...
function parse(source, { sourceMap = true, filename = 'component.vue', sourceRoot = '', pad = false, compiler = CompilerDOM, babelParserPlugins } = {}) {
...
function warnDuplicateBlock(source, filename, node, isScriptSetup = false) {
    ...
    console.warn(`Single file component can contain only one <${node.tag}${isScriptSetup ? ` setup` : ``}> element (${location}):\n\n${codeFrame}`);
}
